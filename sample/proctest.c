...
{13,4130,1,0,0,
5,0,0,0,0,0,27,44,0,0,4,4,0,1,0,1,9,0,0,1,9,0,0,1,10,0,0,1,10,0,0,
36,0,0,2,61,0,4,72,0,0,2,0,0,1,0,2,3,0,0,2,9,0,0,
59,0,0,3,0,0,31,102,0,0,0,0,0,1,0,
};
...
/* EXEC SQL BEGIN DECLARE SECTION; */ 
   ...
   int  no;
   /* varchar name[12]; */ 
struct { unsigned short len; unsigned char arr[12]; } name;
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "select empno ,ename into :b0,:b1  from emp where empno='73\
69'";
